...
function main(): void {
  ...
  for (const level of sorted) {
    ...
    if (level.id >= 21 && level.id <= 35) {
      if (result.unique) unique21_35 += 1;
      else fail += 1;
    }
